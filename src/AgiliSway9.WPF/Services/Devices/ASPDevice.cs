...
namespace AgiliSway
{
    public class ASPDevice : IDevice
    {
		...
		public AgiliSway9.WPF.Models.CollectionDataPoint GetDataPoint()
		{
			return new AgiliSway9.WPF.Models.CollectionDataPoint();
		}
		...
		public Task<AgiliSway9.WPF.Models.CollectionDataSet> Collect(TimeSpan time, IProgress<AgiliSway9.WPF.Models.CollectProgress> progress, System.Threading.CancellationToken ct, CollectionDataPoint calibration)
		{
            return null;
		}
	}
